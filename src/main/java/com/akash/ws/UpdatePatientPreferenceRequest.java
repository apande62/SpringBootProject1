...
@XmlRootElement(name = "updatePatientPreferenceRequest", namespace = "http://optumrx.unitedhealthgroup.com/AM/PatientPreferenceAM/v3_00")
public class UpdatePatientPreferenceRequest {
